...
function CartItem({ product, quantity }: CartItemProps) {
    ...
    return (
        <div
            className="flex items-center gap-2 p-2 rounded-md shadow-md hover:shadow-lg transition bg-white relative"
        >
            ...
            <div className="flex flex-col flex-grow">
                ...
                <div className="flex justify-between text-sm mt-2">
                    <div className="flex items-center gap-1">
                        <label htmlFor={`qty-${product.productId}`} className="text-gray-600">
                            Qty:
                        </label>
                        <select
